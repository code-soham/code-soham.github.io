export default function Navbar() {
  return (
    <div className="w-full bg-base-100 fixed z-50">
      <div className="navbar sticky p-4 m-auto">
        ...
        <div className="navbar-end flex gap-2">
          <a
            href="mailTo:soham36chowdhury@gmail.com"
          ...
          <a href="tel:+916294750719" className="btn btn-sm rounded btn-accent">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <label className="hidden btn btn-circle swap swap-rotate">
