export default function Head() {
  return (
    <div
      className="min-h-screen w-full pr-16 pl-16 text-indigo-900 bg-indigo-400 flex flex-col md:flex-row justify-center md:justify-between text-5xl items-center py-16"
      style={{
    ...
    >
      <div>
        <h1 className="text-2xl sm:text-4xl">Hello humans...</h1>
...
function downDoubleArrow() {
  return (
    <a href="#about" className="absolute bottom-0 left-0 right-0 mx-auto">
      <svg
